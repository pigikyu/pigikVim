...
hi def cCustomFunc   gui=bold term=bold cterm=bold ctermfg=33 guifg=#ff5faf 
hi def cCustomScope  gui=bold term=bold cterm=bold ctermbg=31 ctermfg=15 guifg=#ffff00
hi def cCustomClass  gui=bold term=bold cterm=bold ctermbg=26 guifg=#00ff00 ctermfg=251
